...
;----------------------------------- unpacking -------------------------------------------------------------------------------------------------------------
FileReadLine, auversion, %A_WorkingDir%\AutoUpdate-master\AutoUpdate\AutoUpdate.ahk, 1 ;patch file contains version at first line of file
FileReadLine, aucontrol, %A_ScriptDir%\AutoUpdate.ahk, 1 ;text file containing current version 
